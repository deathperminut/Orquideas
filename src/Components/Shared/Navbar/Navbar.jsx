            ...
            <nav className='navbar navbar-expand pt-0 pb-0 d-flex flex-row justify-content-end align-items-center align-self-center'>
                ...
                <div className='row'>
                    ...
                    <div className='dropdown ms-3'>
                        ...
                        {/* <div className='me-2 rounded-circle position-relative photo-user- cursor- bs-1--'>
                            <img className='card-img' src={''} alt="" />
                            <div className='p-1 rounded-circle position-absolute top-0 end-0 bg-light-green-'></div>
                        </div> */}
                        <div className='d-flex flex-column justify-content-start align-items-start align-self-center'>
                            <p className='m-0 lh-sm fs-5- fontLight tx-black-'>Jonathan</p>
                            <p className='m-0 lh-sm fs-7- fontSemiBold text-uppercase tx-black-'>Administrador</p>
                        </div>
                        </div>
