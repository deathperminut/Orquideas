...
import $ from 'jquery';
import Violeta from '../../../assets/images/violeta.png';
import Azul from '../../../assets/images/Azul2.png';
...
import Cafe from '../../../assets/images/cafe2.png';
import Aguamarina from '../../../assets/images/aguamarina.png';
          ...
          <div className='col-12'>
            <div className="swiper swiper-container-portfolio">
              <div className="swiper-wrapper">
                <div className='swiper-slide d-flex flex-row justify-content-center align-items-center align-self-center mt-4 mb-5'>
