            ...
            <div className='CourseContainer '>
                    <div className='activityInstructionContainer'>
                                        <div className='d-grid gap-2 pt-1' style={{'padding':'10px'}}>
                                            ...
                                            {selectActivity?.hasOwnProperty("video") ?   <p className='fontLight' dangerouslySetInnerHTML={{ __html: selectActivity?.video?.description?.split('-')[2].replace(/\r\n/g, '<br>').replace(/\n/g, '<br>').replace(/\r/g, '') }}/> : <></>}
                                            {selectActivity?.hasOwnProperty("format_text") ?   <p className='fontLight' dangerouslySetInnerHTML={{ __html:  selectActivity?.format_text?.text?.split('-')[2]}}/> : <></>}
                                            {selectActivity?.hasOwnProperty("evidence") ?   <p className='fontLight' dangerouslySetInnerHTML={{ __html: selectActivity?.evidence?.description.split('-')[2].replace(/\r\n/g, '<br>').replace(/\n/g, '<br>').replace(/\r/g, '') }}/> : <></>}
                                            {selectActivity?.hasOwnProperty("redaction") ?   <p className='fontLight' dangerouslySetInnerHTML={{ __html: ''.replace(/\r\n/g, '<br>').replace(/\n/g, '<br>').replace(/\r/g, '') }}/> : <></>}
                                            {selectActivity?.hasOwnProperty("image") ?   <p className='fontLight' dangerouslySetInnerHTML={{ __html:  selectActivity?.image?.description?.split('-')[2]}}/> : <></>}
                                            {selectActivity?.hasOwnProperty("lecture") ?   <p className='fontLight'>{selectActivity?.lecture?.content}</p> : <></>}
                                            {selectActivity?.hasOwnProperty("forum_participation") ?   <p className='fontLight' dangerouslySetInnerHTML={{ __html: selectActivity?.forum_participation?.question?.split('-')[2]}}/> : <></>}
                                            {selectActivity?.hasOwnProperty("cloud_forum_participation") ?  <p className='fontLight' dangerouslySetInnerHTML={{ __html: selectActivity?.cloud_forum_participation?.question?.split('-')[2]}}/> : <></>}
                                            {selectActivity?.hasOwnProperty("selection_multiple_questionary") ?   <p className='fontLight' dangerouslySetInnerHTML={{ __html: selectActivity?.selection_multiple_questionary?.question_text?.split('-')[2]}}/> : <></>}
                                        </div>
                    </div>
                    <div className='activityCourseContainer bs-2-'>
                            ...
                            <div className='format_textActivity'>
                                    <p style={{'textAlign':'center','fontSize':'20px','width':'100%'}} className='fontSemiBold' dangerouslySetInnerHTML={{ __html: selectActivity?.format_text?.text.split('-')[1].replace(/\r\n/g, '<br>').replace(/\n/g, '<br>').replace(/\r/g, '') }}/>
                                    <p style={{'textAlign':'center','fontSize':'20px','width':'100%'}} className='fontLight' dangerouslySetInnerHTML={{ __html: selectActivity?.format_text?.text.split('-')[3].replace(/\r\n/g, '<br>').replace(/\n/g, '<br>').replace(/\r/g, '') }}/>
                            </div>  
                            :
                            <></>
                            }
                            ...
                            <div className='format_textActivity'>
                                            <p style={{'textAlign':'center','fontSize':'20px','textAlign':'center','width':'100%'}} className='fontSemiBold' dangerouslySetInnerHTML={{ __html: selectActivity?.forum_participation?.question.split('-')[1].replace(/\r\n/g, '<br>').replace(/\n/g, '<br>').replace(/\r/g, '') }}/>
                            ...
                            <div className='format_textActivity'>
                                            ...
                                            <span className='fontSemiBold color-purple' style={{'textAlign':'center'}}>Escribe las palabras en el siguiente cuadro de texto y guarda con el botón del final del cuestionario para que se vean reflejadas en la nube, cada palabra debe estar separada por coma. </span>
                                            <div className='col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 mb-3 mb-sm-3 mb-md-4 mb-lg-4 mb-xl-4 mb-xxl-4'>
                            ...
                            {selectActivity?.hasOwnProperty("image") ?   
                                <div className='format_textActivity'>
                                    <p style={{'textAlign':'center','fontSize':'20px','width':'100%'}} className='fontLight' dangerouslySetInnerHTML={{ __html: selectActivity?.image?.description?.split('-')[1].replace(/\r\n/g, '<br>').replace(/\n/g, '<br>').replace(/\r/g, '') }}/>
                            ...
                            {selectActivity?.hasOwnProperty("selection_multiple_questionary") ?   
                                <div className='format_textActivity'>
                                    <p style={{'textAlign':'center','fontSize':'20px','width':'100%'}} className='fontSemiBold' dangerouslySetInnerHTML={{ __html: selectActivity?.selection_multiple_questionary?.question_text.split('-')[1].replace(/\r\n/g, '<br>').replace(/\n/g, '<br>').replace(/\r/g, '') }}/>
                                    <p style={{'textAlign':'center','fontSize':'20px','width':'100%'}} className='fontLight' dangerouslySetInnerHTML={{ __html: selectActivity?.selection_multiple_questionary?.question_text.split('-')[3].replace(/\r\n/g, '<br>').replace(/\n/g, '<br>').replace(/\r/g, '') }}/>
                                    <div className='imageContainerClass'>
                            ...
                            <div className='navBarClass'>
                                    <div onClick={NextActivity}  className='Button_2' style={{'marginLeft':'10px'}}>
                                                    <span className='text_button_2'>Continuar</span>
                                    </div>
                            </div>
