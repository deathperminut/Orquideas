            ...
            <div className='CourseContainer '>
                    <div className='activityInstructionContainer'>
                                        <div className='d-grid gap-2 pt-1' style={{'padding':'10px'}}>
                                            ...
                                            {selectActivity?.hasOwnProperty("evidence") ?   <p className='fontLight' dangerouslySetInnerHTML={{ __html: 'Sigue la descripción de la actividad y adjunta tu evidencia'.replace(/\r\n/g, '<br>').replace(/\n/g, '<br>').replace(/\r/g, '') }}/> : <></>}
                                            {selectActivity?.hasOwnProperty("redaction") ?   <p className='fontLight' dangerouslySetInnerHTML={{ __html: 'Sigue la descripción de la actividad y registra la respuesta en el espacio para texto'.replace(/\r\n/g, '<br>').replace(/\n/g, '<br>').replace(/\r/g, '') }}/> : <></>}
