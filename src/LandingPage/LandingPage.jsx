        ...
        <div style={{width:'100%',minHeight:'100%',display:'flex',flexDirection:'column'}}>
                  ...
                  <div className='dataModulContainerV2'>
                    ...
                    <Accordion >
                        <Accordion.Item className='bs-2- classColaps' eventKey="0">
                            <Accordion.Header className='fontSemiBold'>
                                    ...
                                    <div className='TextContainerClass'>
                                            <span className='fontSemiBold' style={{'textAlign':'center'}}>¡Descubre los nuevos descuentos en nuestros cursos!</span>
                        ...
                        <Accordion.Item className='bs-2- classColaps' eventKey="1">
                            <Accordion.Header className='fontSemiBold'>
                                    <div className='ImageContainerClass'>
                                        <img src={Flores} className='card-img' alt="" />
                                    </div>
                                    <div className='TextContainerClass'>
                                            <span className='fontSemiBold' style={{'textAlign':'center'}}>¡Hemos obtenido un nuevo aliado!</span>
                                            <span className='fontLight dateClass' style={{'textAlign':'center'}}>Publicado el 11 de marzo de 2024</span>
                                    </div>
                            </Accordion.Header>
                            <Accordion.Body>
                        ...
                        <Accordion.Item className='bs-2- classColaps' eventKey="2">
                            <Accordion.Header className='fontSemiBold'>
                                    <div className='ImageContainerClass'>
                                        <img src={Flores} className='card-img' alt="" />
                                    </div>
                                    <div className='TextContainerClass'>
                                            <span className='fontSemiBold' style={{'textAlign':'center'}}>¡Conoce los casos de éxito!</span>
                                            <span className='fontLight dateClass' style={{'textAlign':'center'}}>Publicado el 11 de marzo de 2024</span>
                                    </div>
                            </Accordion.Header>
                            <Accordion.Body>
